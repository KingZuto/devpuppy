  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-100 via-blue-100 to-green-100 dark:from-gray-800 dark:via-gray-700 dark:to-gray-800 flex flex-col items-center justify-center px-4 py-16 transition-colors duration-300">
      ...
      >
        ...
        <div className="text-lg text-center mb-4 flex flex-col gap-2">
          <span style={{ color: isDark ? 'rgb(229, 231, 235)' : 'rgb(31, 41, 55)' }}>Hello!</span>
          <span style={{ color: isDark ? 'rgb(229, 231, 235)' : 'rgb(31, 41, 55)' }}>
          ...
          <span style={{ color: isDark ? 'rgb(229, 231, 235)' : 'rgb(31, 41, 55)' }}>AWS, DevOps, Cloud Infrastructure, Automation, Web Frontend</span>
